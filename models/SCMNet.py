...
def DCM_block(input_tensor):
  ...
  concat = tf.keras.layers.Concatenate()([relu1x1, relu3x3_d6, upsampling1, upsampling2])

  return concat


def model(num_classes=19, input_size=(1024, 2048, 3), shrink_factor=2):
    ...
    deep_branch1 = conv_block(deep_input, 'conv', 32, (3, 3), strides = (2, 2), dilation_rate=(1, 1)) 
